...
NGame = {
	...
	FUEL_RESOURCE = "resource_food",							-- resource that will give country fuel
	...
	HANDS_OFF_START_TAG = "EUR",					-- tag for player country for -hands_off runs. use an existing tag that is less likely to affect the game
	ALERT_SFX_COOLDOWN_DAYS = 14,					-- After playing an alert sound, don't play the same sound for XXX days, even if it fires again.
},

NDiplomacy = {
	DIPLOMACY_REQUEST_EXPIRY_DAYS = 28,
	...
	TRUCE_BREAK_COST_PP = 240,						-- Base cost in PP of breaking a truce by joining a war or accepting a call to war ( you cannot declare war yourself until the truce if up ), this is then multiplied by the time left on the truce ( so once half the truce is up it only cost 50% of this )
	...
	VERY_GOOD_OPINION = 80,							-- Threshold for a country that has a very good opinion of you.
	VERY_BAD_OPINION = -80,							-- Threshold for a country that has a very bad opinion of you.
	...
	FLEET_FEAR = 0.8,									-- Impact on troops on borders when deciding how willing a nation is to trade
	...
	GUARANTEE_COST = 100,							-- Scale with the number of already guaranteed countries.
...
NCountry = {
	...
	VP_TO_SUPPLY_BASE = 0.75,							-- Bonus to supply from a VP, no matter the level
	...
	POLITICAL_POWER_CAP = 999.9,					-- Max amount of political power country should have
	...
	BASE_FUEL_GAIN_PER_OIL = 0.2,						-- base amount of fuel gained hourly per excess oil
	BASE_FUEL_GAIN = 0.05,							-- base amount of fuel gained hourly, independent of excess oil
	BASE_FUEL_CAPACITY = 1000,						-- base amount of fuel capacity
...
NPolitics = {
	...
	BASE_POLITICAL_POWER_INCREASE = 0,	-- Daily increase of PP.
...
NBuildings = {
	...
	INFRASTRUCTURE_RESOURCE_BONUS = 0.075, -- multiplactive resource bonus for each level of (non damaged) infrastructure
},
